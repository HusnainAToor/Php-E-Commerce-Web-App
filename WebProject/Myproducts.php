     ...
     echo '<table style=" border: 5px solid black;">';
      ...
      while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
         ...
         echo '<td style="width:100px; height:100px; margin-bottum:20px; text-align: center;">' . $tname . '</td>';  
           ...
           echo '<td style="width:100px; height:100px; margin-bottum:20px;"><a href="Addtocart.php?id='.$id.'"> <input type="button"  value="Add" ></a></td>';  
      ...
      echo '<center><a href="one.php"><input type="submit" value="SHOW CART" style="width:400; height:50; margin-left:50; margin-top:50; background-color:lightblue; "></a></center>';        
