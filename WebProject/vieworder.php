...
session_start();
 ...
 $name=$_SESSION['name'];
      ...
      $host = '127.0.0.1';
		...
		$sql = "select * from order1 where name='$name'";
	...
	echo '<table style=" border: 5px solid black;">';
      ...
      while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
         ...
         echo '<td style="width:100px; height:100px; margin-bottum:20px; text-align: center;">' . $tname . '</td>';  
		  ...
		  echo '<td style="width:100px; height:100px; margin-bottum:20px;"><a href="orderdetail.php?id='.$Qname.'"> <input type="button"  value="View Order" ></a></td>'; 
